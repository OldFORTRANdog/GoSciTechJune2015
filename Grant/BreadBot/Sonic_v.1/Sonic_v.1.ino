...
// IO Pins used
const byte LEFT_BUMP_PIN = 46;    // Define DIGITAL Pins for left
const byte RIGHT_BUMP_PIN = 47;   // and right bump sensors
const byte SONIC_TRIGGER_PIN = 50;
const byte SONIC_ECHO_PIN = 51;

// Parameters controlling program behavior
// Bump behavior
const byte FORWARD_SPEED = 200;   // Define normal speeds
const byte BACKWARD_SPEED = 120;  // and backup/turn speed
