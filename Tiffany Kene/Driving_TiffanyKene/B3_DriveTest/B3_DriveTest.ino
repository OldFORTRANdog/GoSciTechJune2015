/* B3_DriveTest.ino
   ...
   Start new one after a 5 second time interval.km
...
#define TRIALWAITTIME 1000
#define TREATMENTWAITTIME 2000
...
void loop(void){
  ...
  // delay(500); // Delay for two seconds to give time to place the robot.
