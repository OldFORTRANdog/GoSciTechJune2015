...
void loop(void){
  ...
  for ( byte leg = 1; leg < 16; leg++ ) {
    duration = 1;
    magnitude = 50;
    //    brake = 0; // No braking                                                                                                                        //rooster
    switch (leg) {
      delay(1000);
    case 1: // Move right
      direction = 90.;
    ...
    case 8: // Move left
      ...
      break;
      delay(100);
    case 9: // Move forwards
      direction = 0.;
      break;
      delay(100);
    case 10: // Move backwards
      direction = 180.;
      break;
      delay(100);
    case 11: // Move forwards
      direction = 0.;
      break;
      delay(100);
    case 12: // Move backwards
      direction = 180.;
      break;
      delay(100);
    case 13: // Move forwards
      direction = 0.;
      break;
      delay(100);
    case 14: // Move backwards
      ...
      break;
      delay(100);
    case 15: // Move forwards
      direction = 0.;
      break;
      delay(100);
    case 16: // Move backwards
      direction = 180.;
      break;
     delay(100); 
