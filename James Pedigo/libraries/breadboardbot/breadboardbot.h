...
#define TRACKWIDTH 10.0; // inches       the units used everywhere for distance

/*const byte TURNLEFT = 0;
const byte TURNRIGHT = 1;
*/
const int tireDiam = 2.75; // inches. 
...
float duration_per_distance( float distance, byte speed) {
  ...
  float dist_per_sec = (0.1428 * float(speed)) - 0.82;// in inches, from data
