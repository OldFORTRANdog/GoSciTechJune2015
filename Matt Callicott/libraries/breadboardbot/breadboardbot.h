...
const float trackWidth = 14; /* Actually 9 inches  for 155 speed  Use 14 for good angle */
...
float duration_per_distance( float distance, byte speed) {
  /* Find drive time in milliseconds from relatio`nship developed from
     observations of distance/time for a speed.  */
  float dist_per_sec = (0.1529 * float(speed)) - 1.948;// in inches, from data
...
void drive(float distance, byte speed,
  ...
  mRight.setSpeed(speed*1.06); /* Adds speed to Right Motor to keep Straight */
